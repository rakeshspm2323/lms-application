  ...
  return (
    ...
    <div className="container-wrapper mx-auto">
        <div className="flex flex-col justify-center items-center md:px-5 px-3 md:mb-10 mb-7">
            <h2 className="md:text-[36px] text-3xl font-semibold mb-3 bg-[linear-gradient(90deg,#FC466B_0%,#3F5EFB_100%)] bg-clip-text text-transparent md:text-center text-start">Featured Learning Paths</h2>
            <p className="md:text-lg text-md font-medium text-gray-600 md:text-center text-start w-full md:max-w-2xl md:leading-7 leading-6">
